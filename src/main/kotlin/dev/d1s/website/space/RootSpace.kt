...
suspend fun ApplicationContext.rootSpace() {
    space {
        englishTranslation()
        russianTranslation()
...
private suspend fun SpaceContext.view() {
    setView {
        ...
        title = WebsiteTranslation.LOCATION_ROOT_TITLE.asTemplate
        description = WebsiteTranslation.LOCATION_ROOT_DESCRIPTION.asTemplate
    }
}
