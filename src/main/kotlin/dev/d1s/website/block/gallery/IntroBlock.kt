...
package dev.d1s.website.block.gallery
...
private fun ContentEntitiesBuilder.heading() {
    firstHeading(value = WebsiteTranslation.LOCATION_GALLERY_INTRO_HEADING.asTemplate)
}

private fun ContentEntitiesBuilder.text() {
    text(value = WebsiteTranslation.LOCATION_GALLERY_INTRO_PARAGRAPH.asTemplate)
}